...
{
	//the url of page which contains all the url of the tag
	private String tagCorrespondedURL=null; 
	//the tag typed from the beginning
	private String articleTag=null;
	...
	public String getTagCorrespondedURL()
	{
		return tagCorrespondedURL;
	}
	public void setTagCorrespondedURL(String tagCorrespondedURL)
	{
		this.tagCorrespondedURL = tagCorrespondedURL;
	}
