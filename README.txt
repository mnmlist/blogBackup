# CSDN BlogBackupSystem
  You can use my system to backup the CSDN blog in three ways,namely totally backup,backup by tag,backup by colums.You can run my program in eclipse,the backup articles will be found in the home directory of the program,and you can view the articles via the Chrome,Firefox.PS.I'm recently add an option that you can convert the articles of a month to .pdf file,you can test the option from the main method of com.mnmlist.backup.byTotal.pdf.Spider.java.  9/1/2015.
